...
function FormMoleculesShowcase() {
  ...
  return (
    <section className="py-16">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-text-primary mb-4">
            Form Molecules Showcase
          </h2>
          <p className="text-lg text-text-secondary max-w-3xl mx-auto">
            Experience our comprehensive collection of form molecule components with 
        ...
        <div className="space-y-8">
          ...
          <Card className="p-6">
            <h3 className="text-xl font-bold text-text-primary mb-4 flex items-center space-x-2">
              <span>FormField</span>
              <Badge variant="success" size="sm">Universal Wrapper</Badge>
            </h3>
          ...
          <Card className="p-6">
            <h3 className="text-xl font-bold text-text-primary mb-4 flex items-center space-x-2">
              <span>SearchBox</span>
              <Badge variant="primary" size="sm">Debounced</Badge>
            </h3>
          ...
          <Card className="p-6">
            <h3 className="text-xl font-bold text-text-primary mb-4 flex items-center space-x-2">
              <span>Textarea</span>
              <Badge variant="success" size="sm">Auto-Resize</Badge>
            </h3>
    ...
    <section className="py-16">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="text-center p-6">
            <div className="text-3xl font-bold text-success-600 mb-2">424</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="text-center lg:text-right">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-center lg:justify-end space-x-2 group">
                <div className="w-2 h-2 bg-success-500 rounded-full group-hover:scale-125 transition-transform duration-200"></div>
                <span className="text-sm text-text-secondary group-hover:text-text-primary transition-colors duration-200">424 Tests Passing</span>
              </div>
              <div className="flex items-center justify-center lg:justify-end space-x-2 group">

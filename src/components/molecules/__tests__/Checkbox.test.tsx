...
describe('Checkbox', () => {
  ...
  it('does not render description when error is present', () => {
    ...
    render(<Checkbox label="Accept terms" description={description} error={error} />);
  ...
  it('applies different colors correctly', () => {
    const { container: primaryContainer } = render(<Checkbox checked color="primary" />);
    const { container: successContainer } = render(<Checkbox checked color="success" />);

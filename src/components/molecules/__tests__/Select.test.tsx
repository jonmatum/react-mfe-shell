...
describe('Select', () => {
  ...
  it('clears selection when clear button is clicked', async () => {
    ...
    render(<Select options={mockOptions} clearable value="us" onChange={onChange} />);
  ...
  it('handles disabled options', async () => {
    ...
    expect(disabledOption.closest('[role="option"]')).toHaveClass('opacity-50', 'cursor-not-allowed');
  });
  ...
  it('creates hidden input for form compatibility', () => {
    const { container } = render(<Select options={mockOptions} name="country" value="us" />);
  ...
  it('handles multiple values in hidden input', () => {
    const { container } = render(
      <Select options={mockOptions} name="countries" multiple value={['us', 'ca']} />
    );
  ...
  it('uses custom renderValue function', () => {
    ...
    render(<Select options={mockOptions} value="us" renderValue={renderValue} />);

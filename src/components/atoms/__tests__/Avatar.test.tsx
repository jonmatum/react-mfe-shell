...
describe('Avatar', () => {
  ...
  describe('Image Handling', () => {
    it('renders image when src is provided', () => {
      render(
        <Avatar src='/test-avatar.jpg' alt='John Doe' fallback='John Doe' />
      );
    ...
    it('shows fallback when image fails to load', async () => {
      render(
        <Avatar src='/invalid-image.jpg' alt='John Doe' fallback='John Doe' />
      );
  ...
  describe('Edge Cases', () => {
    ...
    it('handles very long fallback text', () => {
      render(
        <Avatar fallback='Very Long Name With Many Words That Should Be Truncated' />
      );

...
export type PolymorphicOwnProps<E extends React.ElementType = React.ElementType> = {
  as?: E;
};
...
export type PolymorphicComponentProps<
  ...
  Props = {}
> = Props & PolymorphicOwnProps<E> & Omit<React.ComponentProps<E>, keyof (Props & PolymorphicOwnProps<E>)>;
...
export type InteractiveElements = 'button' | 'a' | 'input' | 'textarea' | 'select';
export type ContainerElements = 'div' | 'section' | 'article' | 'aside' | 'main' | 'header' | 'footer';
